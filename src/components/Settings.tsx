...
const reciters = [
  ...
  { label: 'Abdur-Rahman As-Sudais', value: 'ar.abdurrahmaansudais' },
  { label: 'Ali Al-Hudhaify', value: 'ar.hudhaify' },
  { label: 'Maher Al Muaiqly', value: 'ar.mahermuaiqly' },
  { label: 'Mohamed Siddiq El-Minshawi', value: 'ar.minshawi' }
];
  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-gray-900 p-6 rounded-lg shadow-xl w-[90vw] max-w-lg max-h-[85vh] overflow-y-auto">
